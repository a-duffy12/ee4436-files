...
while True: 
    soc.sendto(b"Multicasting Assignment ECE 4436 from Server 1", ("224.1.1.1", 2806)) # send message
    print("Server 1: Multicast packet is sent now!") # print that message was sent
